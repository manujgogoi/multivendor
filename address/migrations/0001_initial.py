# Generated by Django 3.2.9 on 2021-12-08 01:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('house_no', models.CharField(blank=True, help_text='House No./ Door No./ Flat No./ Apartment No./ Qtr No.', max_length=50, null=True, verbose_name='House No')),
                ('landmark', models.CharField(max_length=100, verbose_name='Landmark')),
                ('village_or_town', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='addresses', to='address.villageortown')),
            ],
        ),
    ]
